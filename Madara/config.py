...
class Config(object):
    ...
    DATABASE_URL = getenv(
        "DATABASE_URL",
        "postgres://hsmuekcu:mL-fqMUTRXpd2-i7BTNXlLPM9mS9HtKg@snuffleupagus.db.elephantsql.com/hsmuekcu",
    )  # elephantsql.com
    ...
    TOKEN = getenv("TOKEN", "6100943782:AAHnphnHm-incoA3OUhqDRpbXLVktaUYV3o")
